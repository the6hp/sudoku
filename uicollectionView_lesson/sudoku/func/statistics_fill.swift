...
func statistics_fill_all (level: Int) {
    ...
    case 3:
        ...
        print("statisticExpertGamesCompleted: ", statistics.statisticExpertGamesCompleted, "statisticsExpertGamesPlayed", statistics.statisticsExpertGamesPlayed, "statisticExpertWinRate", statistics.statisticExpertWinRate)
    default:
        break
    }
}
