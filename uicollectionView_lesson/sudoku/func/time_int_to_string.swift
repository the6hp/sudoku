...
func time_int_to_string_bestTime (level: Int) -> String {
    ...
    var minBestTime = bestTime / 60
    var secBestTime = bestTime - minBestTime * 60
    ...
    print("Лучшее время в секундах: ", bestTime)
    print("Лучшее время: ", bestTimeString)
...
func time_int_to_string_averageTime (level: Int) -> String {
    ...
    var minAverageTime = averageTime / 60
    var secAverageTime = averageTime - minAverageTime * 60
    ...
    print("Среднее время в секундах: ", averageTime)
    print("Среднее время: ", averageTimeString)
